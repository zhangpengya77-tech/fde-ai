...
urlpatterns = [
    ...
    path("teacher/surveys/", views.teacher_survey_dashboard, name="teacher_survey_dashboard"),
    path("teacher/surveys/<int:enrollment_id>/", views.teacher_survey_detail, name="teacher_survey_detail"),
