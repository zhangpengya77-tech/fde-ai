...
- 做：第一版只做 Pixhawk 2.4.8 的 F450 組裝與調參流程，支援照片與 30 秒影片入口，AI 助教使用本機 RAG 教材知識庫。
...
- AI 助教：目前採 RAG-only 本機教材模式，不需要 OpenAI API Key；把 `.txt` / `.md` 教材放進 `E:\FDE_AI_Voice_RAG\knowledge_base` 後即可查詢。
