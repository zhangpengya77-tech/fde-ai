...
const missionTasks = window.FdeCourseDefinitions.tasks

const missionPacks = missionTasks.map((task) => ({
  code: task.id,
  title: task.title,
...
window.FdePlatform = { hero, designSystem, moduleSections, platformModes, workflowSteps, missionStages, missionTasks, missionPacks, cohorts, learningPath, studentDashboard, youtubeVideos, learningTrackPreviewCount, learningTracks, learningResources, practiceResources, buildWorkflow, voiceAssistant, ragKnowledgeBase, searchKnowledgeBase, assessmentWorkflows, teacherDashboard, certificationChecklist, calculateProgress, simulateBuildAssistant, simulatePropellerAssessment, simulateHoverAssessment };
